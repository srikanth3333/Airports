...
import { get, size, set, forEach, isEmpty,isString } from 'lodash'
...
const translateTerminal = (terminal = '') => {
  if (!isString(terminal)) { return 'KLIA'}
...
export default handleActions({
  [flightInfo.SET_TERMINAL]: (state, { payload }) => {
    return {
      ...state,
      terminal: translateTerminal(payload)
    }
  },
